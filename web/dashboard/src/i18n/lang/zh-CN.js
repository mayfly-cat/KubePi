...
const message = {
  commons: {
    ...
    personal: {
      ...
      star: "点亮 Star",
      version: "版本",
      copy_right: "Copyright © 2014-2025 飞致云",
  ...
  business: {
    ...
    ingress: {
      history: "历史版本",
      history_version: "版本号",
      history_operator: "操作人",
      history_description: "描述",
      history_detail: "历史版本详情",
      rollback: "回滚",
      rollback_confirm: "确定要回滚到版本 {version} 吗？",
      rollback_success: "回滚成功",
      rollback_failed: "回滚失败",
      rollback_disabled_current_version: "当前版本，无法回滚",
      rollback_disabled_no_permission: "没有更新权限，无法回滚",
      rollback_tooltip: "回滚到版本 {version}",
      no_history_version: "暂无历史版本记录",
      load_history_failed: "加载历史版本失败",
      load_history_detail_failed: "加载历史版本详情失败",
