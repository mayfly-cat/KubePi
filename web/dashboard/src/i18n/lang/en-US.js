...
const message = {
  commons: {
    ...
    personal: {
      ...
      star: "Star",
      version: "Version",
      copy_right: "Copyright © 2014-2025 FIT2CLOUD",
  ...
  business: {
    ...
    ingress: {
      ...
      rollback: "Rollback",
      rollback_confirm: "Are you sure to rollback to version {version}?",
      rollback_success: "Rollback successful",
      rollback_failed: "Rollback failed",
      rollback_disabled_current_version: "Current version, cannot rollback",
      rollback_disabled_no_permission: "No update permission, cannot rollback",
      rollback_tooltip: "Rollback to version {version}",
      no_history_version: "No history version records",
      load_history_failed: "Failed to load history",
      load_history_detail_failed: "Failed to load history detail",
